...
<body>
    <div class="center-area">
        <nav class="center-area__topbar">
            <a class="center-area__topbar__logo">
                <img src="assets/images/icon.png" alt="<?= $app_details["name"] ?> Logo">
                <h1 class="center-area__topbar__title"><?= $app_details["name"] ?></h1>
                <p class="center-area__topbar__description"><?= $app_details["description"] ?></p>
            </a>
        </nav>
